...
//            Intent intent = new Intent(getApplicationContext(), SettingsActivity.class);
    ...
    public static class DetailFragment extends Fragment {
        ...
        public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
            ...
            //get the provider and hold on it to change/set the share intent
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            TextView textView = (TextView) rootView.findViewById(R.id.result_string);

            Intent intent = getActivity().getIntent();
            if(intent != null && intent.hasExtra("item_clicked")) {
                mForecastStr = intent.getStringExtra("item_clicked");
