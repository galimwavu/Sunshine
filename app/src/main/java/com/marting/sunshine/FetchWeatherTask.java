...
import com.marting.sunshine.data.WeatherContract;
import com.marting.sunshine.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        //return the uri from the locationSettings string
        Uri weatherLocationUri = WeatherEntry.buildWeatherLocation(locationSetting);
        //return the cursor which has the weather data
